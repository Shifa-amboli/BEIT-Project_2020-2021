    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        <header class="templatemo-site-header">
		  ...
		  <?php
		  $Welcome = "Welcome";
          echo "<h1>" . $Welcome . "<br>". $_SESSION['username']. "<br>". $currentDate = date('Y-m-d h:i:sa')."</h1>";
		  ?>
        </header>
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li>
              <a href="Placement Drives/drivehome.php"><i class="fa fa-bar-chart fa-fw"></i>Placement Drives</a>
            </li>
            <li>
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li>
                  <a href="../../Homepage/index.php">Home APSIT-PMS</a>
                </li>
                <li>
                  <a href="Placement Drives/drivehome.php">Drives Homepage</a>
                </li>
                <li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to APSIT-PMS</h2>
              <hr>
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Brace yourself for the Events that will take ur breath away. Get Started and be a Part of APSIT-PMS Family</p>
                  </div>
                </div>
              </div>
            </div>
